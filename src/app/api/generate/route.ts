...
export async function POST(req: NextRequest) {
  ...
  const clientName = body.get("clientName"); 
  const industryTypeValue = body.get("industryType");
  const industryType = industryTypes.find((industryType) => industryType.value === industryTypeValue)?.label;
